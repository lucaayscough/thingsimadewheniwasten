...
<div id="contact_form">
<form action="contact_approvato.php" method="post">
<div id="internal">

E-Mail: (la vostra E-Mail cosi potro' ri-contattarvi)<br />
<input type="textarea" name="email" />

<br /><br />

Oggetto:<br />
<input type="textarea" name="oggetto" />

<br /><br />

Messaggio:<br />
<textarea name="messaggio" style="background-color: #777; border: 2px solid #fff; height: 300px; width: 550px; margin-top: 5px;"></textarea>

<br /><br />

Anti SpamBot, metti Si.<br />
