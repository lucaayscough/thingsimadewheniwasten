<title>Edit Random News - Pokémon X-Treme</title>
...
<center><img src="/images/targhette_principali/add_random_news.png" height="91px" width="306px" alt="Add Release" /></center>

<br />

<form method="post">

<center><textarea cols="120" rows="20" name="random_news"><?php include('random_news.txt'); ?></textarea></center>
...
$random_news = $_POST['random_news'];
$random_news_open = fopen("random_news.txt","w");
fwrite ($random_news_open,$random_news);
fclose ($random_news_open);
